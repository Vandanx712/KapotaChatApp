...
import { Eye, EyeOff, Loader2, Lock, Mail, MessageSquare, User, UserCheck } from 'lucide-react'
...
function Signup() {
  ...
  return (
    <div className='min-h-screen mt-5 grid lg:grid-cols-2'>
      ...
      <AuthImagePattern title='Join the Conversation' subtitle='Meet new people, share moments, and chat without limits.'/>
    </div>
  )
}
